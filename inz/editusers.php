...
if($page=='view'){
    ...
    if ($input['action'] == 'edit') {
        $mysqli->query("UPDATE users SET email='" . $input['email'] . "', user_password='" . $input['user_password'] . "', houses_id='$houses_id', name='" . $input['name'] . "', surname='" . $input['surname'] . "', birth_date='" . $input['birth_date'] . "', phone_number='" . $input['phone_number'] . "', number_of_completed_works='" . $input['number_of_completed_works'] . "', admin_status='" . $input['admin_status'] . "', purchases='" . $input['purchases'] . "' WHERE (id='" . $input['id'] . "' and houses_id=$houses_id)");
