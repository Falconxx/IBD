...
window.cookieconsent.initialise({
					...
					<div class="table-responsive">
						<table border="0" cellpadding="0" cellspacing="0" style="background: rgba(255,255,255,0.6); " class="mobilewrapper" id="dynamic_field">
							<tr>
                                ...
                                <td class="colsplit" width="15%"><input type="text"  name="equipment[]" placeholder="Equipment" class="form-control equipment_list" /></td>
								...
								<?php
								    for($q=0;$q<sizeof($clmNames);$q++)
									{
										if($usernames==$clmNames[$q])
										{
											...
											$usersql="SELECT id FROM users WHERE name LIKE '$usernames'";
 ...
 echo $rezult; ?> </option>
                                ...
                                <td class="colsplit" width="14.5%"><input type="text"  name="description[]" placeholder="Description" class="form-control description_list" /></td>
                                <td class="colsplit" width="7%"><input type="number"  name="price[]" placeholder="Price" class="form-control price_list" /></td>
                                <td class="colsplit" width="15.5%"><input type="number"  name="effort_hours[]" placeholder="Effort Hours" class="form-control effort_hours_list" /></td>
