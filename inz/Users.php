        ...
        <table id="tabledit"  class="table table-bordered table-striped">
            <thead>
                <tr>
                    ...
                    <input id="btnshow" class="btn btn-info" type="button" value="Show Emails"/>
                    <th>Email <input id="btnHide" class="btn btn-success" type="button" value="Hide Emails"/></th>
                    <input id="btnshow1" class="btn btn-info" type="button" value="Show Passwords"/>
                    <th>Password <input id="btnHide1" data-modal="modal" class="btn btn-success" type="button" value="Hide Passwords"/></th>
                    <input id="btnshow2" class="btn btn-info" type="button" value="Show Names"/>
                    <th>Name <input id="btnHide2" class="btn btn-success" type="button" value="Hide Names"/></th>
                    <input id="btnshow3" class="btn btn-info" type="button" value="Show Surnames"/>
                    <th>Surname <input id="btnHide3" class="btn btn-success" type="button" value="Hide Surnames"/></th>
                    <input id="btnshow4" class="btn btn-info" type="button" value="Show Birthdates"/>
                    <th>Birth Date <input id="btnHide4" class="btn btn-success" type="button" value="Hide Birthdates"/></th>
                    <input id="btnshow5" class="btn btn-info" type="button" value="Show Phones"/>
                    <th>Phone Number <input id="btnHide5" class="btn btn-success" type="button" value="Hide Phones"/></th>
                    <input id="btnshow6" class="btn btn-info" type="button" value="Show Works"/>
                    <th>Number of completed works <input id="btnHide6" class="btn btn-success" type="button" value="Hide Works"/></th>
                    <input id="btnshow7" class="btn btn-info" type="button" value="Show Status"/>
                    <th>Status <input id="btnHide7" class="btn btn-success" type="button" value="Hide Status"/></th>
                    <input id="btnshow8" class="btn btn-info" type="button" value="Show Purchases"/>
                    <th>Purchases <input id="btnHide8" class="btn btn-success" type="button" value="Hide Purchases"/></th>
