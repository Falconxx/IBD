        ...
        <table id="tabledit"  class="table table-bordered table-striped">
            <thead>
                ...
                <th style="display:none;">Id</th>
                    ...
                    <input id="btnshow1" class="btn btn-info" type="button" value="Show Equipment"/>
                    <th>Equipment <input id="btnHide1" class="btn btn-success" type="button" value="Hide Equipment"/> </th>
                    <input id="btnshow2" type="button" class="btn btn-info" value="Show Status"/>
                    <th>Status <input id="btnHide2" class="btn btn-success" type="button" value="Hide Status"/> </th>
                    <input id="btnshow3" type="button" class="btn btn-info" value="Show User"/>
                    <th>User <input id="btnHide3" class="btn btn-success" type="button" value="Hide User"/> </th>
                    <input id="btnshow4" type="button" class="btn btn-info" value="Show Priority"/>
                    <th>Priority <input id="btnHide4" class="btn btn-success" type="button" value="Hide Priority"/> </th>
                    <input id="btnshow5" type="button" class="btn btn-info" value="Show Description"/>
                    <th>Description <input id="btnHide5" class="btn btn-success" type="button" value="Hide Description"/> </th>
                    <input id="btnshow6" type="button" class="btn btn-info" value="Show Price"/>
                    <th>Price <input id="btnHide6" class="btn btn-success" type="button" value="Hide Price"/> </th>
                    <input id="btnshow7" type="button" class="btn btn-info" value="Show Effort Hours"/>
                    <th>Effort Hours <input id="btnHide7" class="btn btn-success" type="button" value="Hide Hours"/> </th>
                </tr>
            </thead>
            <tbody></tbody>
        </table>
